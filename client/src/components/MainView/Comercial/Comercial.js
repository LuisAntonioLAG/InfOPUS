...
const Comercial = () => {
    ...
    return(
        ...
        <Painel data={[]} titulo={'TREINAMENTOS'} descricao={'Vídeos de treinamentos referentes à Diretoria Comercial'} icone={<YouTubeIcon className={classes.cardIcon} color='secondary'/>}/>
